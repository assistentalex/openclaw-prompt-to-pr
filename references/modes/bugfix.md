...
If the fix changes a previewable output (UI, HTML, email, rendered docs, generated text, dashboard, screenshot, template output), propose 1–2 concrete preview tests before PR/commit.
Default shape:
